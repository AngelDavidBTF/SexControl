...
1. **Solo aspecto.** No cambies lógica, servicios, rutas ni datos. Ninguna lectura o escritura nueva de Firestore (plan gratuito). No cambies `appId`, claves `sexcontrol.*` de localStorage, proyecto de Firebase ni dominio.
